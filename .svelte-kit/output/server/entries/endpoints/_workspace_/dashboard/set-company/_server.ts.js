...
import { d as db, a as userCompanies } from "../../../../../chunks/db.js";
import { and, eq } from "drizzle-orm";
const COOKIE_NAME = "selected_company_id";
const COOKIE_OPTIONS = { path: "/", httpOnly: true, sameSite: "lax", maxAge: 60 * 60 * 24 * 365 };
const POST = async ({ request, cookies, locals, params, url }) => {
  if (!locals.user?.id) {
